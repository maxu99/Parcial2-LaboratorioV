...
import com.example.SimulacroParcial.interfaces.PublicacionDueñoComentario;
...
public class UsuarioController {
    ...
    @Autowired
    PublicacionDueñoComentario repo2;
    ...
    @GetMapping("/proyection/1")
    public List proyection(){
        return repository.getResultado();
    }

    @GetMapping("/proyection/2")
    public List proyection2(){
        return repo2.resultado();
    }
